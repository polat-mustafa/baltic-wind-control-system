...
2. **No hardcoded whitelist** — accept any language Codex can write fluently (English, Turkish, Polish, German, French, Spanish, Portuguese, Dutch, Italian, Japanese, Korean, Chinese, Arabic, etc.)
...
- Changes to files outside the project's domain scope (e.g., `.Codex/settings.local.json`, IDE configs)
