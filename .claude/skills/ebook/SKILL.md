...
## CHARACTERS ESTABLISHED (through Ch 29)
...
| **Piotr Zawadzki** | PSE Duty System Operator, Warsaw | Ch 25 | Polish; voice only (radio call); calm, professional, clipped — delivers difficult information in complete sentences with numbers, never editorialising; has handled hundreds of contingency events | Known only by voice and job title; "Confirmed. Łagisza B tripped at 22:14. Approximately eleven hundred megawatts, thermal, eastern Poland." Returns in Ch 37 and Ch 42 as the PSE grid operator voice during commissioning events |
...
- Cybersecurity Lead (Ch 31), Safety Officer (Ch 32, Ch 41), Data Scientist (Ch 33), ML Engineer (Ch 34-36), Commissioning Lead (Ch 38), Grid Operator (Ch 37)
