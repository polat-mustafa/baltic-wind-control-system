...
_POWER_CURVE_SPEEDS_MS: NDArray[np.floating] = np.array([
    ...
    10.5, 11.0, 11.5, 12.0, 12.5, 13.0, 14.0, 15.0, 16.0, 18.0,
    20.0, 22.0, 24.0, 26.0, 28.0, 30.0, 31.0, 32.0,
], dtype=np.float64)

_POWER_CURVE_KW: NDArray[np.floating] = np.array([
    0.0, 0.0, 200.0, 700.0, 1500.0, 2700.0, 4200.0, 6100.0, 8300.0, 10500.0,
    11400.0, 12400.0, 13300.0, 14200.0, 15000.0, 15000.0, 15000.0, 15000.0, 15000.0, 15000.0,
    15000.0, 15000.0, 15000.0, 15000.0, 15000.0, 15000.0, 15000.0, 0.0,
], dtype=np.float64)
...
_CT_CURVE_VALUES: NDArray[np.floating] = np.array([
    0.0, 0.0, 0.90, 0.88, 0.85, 0.82, 0.78, 0.72, 0.60, 0.45,
    0.40, 0.36, 0.33, 0.30, 0.28, 0.25, 0.20, 0.17, 0.14, 0.10,
    0.08, 0.06, 0.05, 0.04, 0.04, 0.03, 0.03, 0.0,
], dtype=np.float64)
