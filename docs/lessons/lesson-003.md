# Ders 003 — P1 Başlangıcı: Veritabanı Modelleri, ERA5 Rüzgar Verisi İşleme ve Weibull Analizi

!!! abstract "Ders Navigasyonu"
    :material-arrow-left: **Önceki:** [Ders 002 — Uluslararasılaştırma](lesson-002.md) | **Sonraki:** Yakında :material-arrow-right:

    **Faz:** P1 | **Dil:** Türkçe | **İlerleme:** 4 / 4 | [Tüm Dersler](index.md) | [Öğrenme Yol Haritası](../Learning_Roadmap.md)
