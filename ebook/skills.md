...
| 11 | Control room, layout screen | Kaan, Layout Engineer | "It's like chess, but the pieces fight the wind" | Day 6 |
...
| 17 | OSS switchgear room | Kaan, HV Technician | The hum of 220 kV transformers — respect for voltage | Week 4 |
| 18 | Control room, load flow screen | Kaan, mentor | Where does 510 MW actually go? | Week 5 |
| 19 | OSS, breaker panel | Kaan, Protection Engineer | "What if everything fails?" — IEC 60909 | Week 5 |
...
- `[ ]` Ch 9: Measuring and Modelling the Wind
- `[ ]` Ch 10: Wake Effects
- `[ ]` Ch 11: Layout Optimization
- `[ ]` Ch 12: How Much Energy? AEP, Uncertainty, and the P90

### Part IV: Building in the Sea (~45 pages)
- `[ ]` Ch 13: Foundations: Monopile, Jacket, and Floating
- `[ ]` Ch 14: Submarine Cables: 45 Kilometers Under the Sea
- `[ ]` Ch 15: Installation

### Part V: The Invisible Highway — Electrical Engineering (~80 pages)
- `[ ]` Ch 16: AC Fundamentals
- `[ ]` Ch 17: Cables, Transformers, and Equipment
- `[ ]` Ch 18: Load Flow
- `[ ]` Ch 19: Short-Circuit Analysis
