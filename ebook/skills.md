...
| Field | Value |
|-------|-------|
| **Last completed chapter** | Chapter 19: Short-Circuit Analysis — Preparing for the Worst (`part-05-electrical-engineering/ch-19-short-circuit.md`) |
| **Last completed file** | `part-05-electrical-engineering/ch-19-short-circuit.md` |
| **Next chapter to write** | Chapter 20: The Ferranti Effect and the STATCOM Decision (`part-05-electrical-engineering/ch-20-ferranti-statcom.md`) |
| **Kaan's location** | OSS relay testing room → corridor toward STATCOM door, Week 5. |
| **Kaan's emotional state** | Met Sigrid Lund (Norwegian protection engineer). Understood IEC 60909-0 short-circuit methodology, Fortescue's symmetrical components, Type 4 converter fault current limit (1.2× rated vs 5-10× for synchronous gen). Calculated I"k = 4.73 kA at 220 kV, 12.5 kA at 66 kV — all within GIS ratings with 4-8× margin. 1965 Northeast Blackout (one stale relay → 30 million people dark) established why protection settings must be dated and updated. Anders has opened the corridor door toward the STATCOM room. The Ferranti effect is next. |
| **Last narrative sentence** | "Behind him, through the observation window, the cooling fans of a hundred and eighty megavars of power electronics turned without interruption." |
| **Total words written** | ~132,000 (preface + how-to-read + Ch 1-19) |
| **Total chapters complete** | 19 / 48 |
| **Session count** | 20 |
...
| 20 | STATCOM room | Kaan, STATCOM Specialist | The Ferranti revelation — 85.5 MVAR from cable alone | Week 6 |
| 21 | OSS, harmonic monitor | Kaan, Power Quality Engineer | Invisible pollution — THD and resonance | Week 6 |
| 22 | TSO coordination call | Kaan, PPC Lead | Grid codes are a social contract, not just rules | Week 7 |
| 23 | Control room, FRT sim | Kaan, mentor | The terror of riding through a fault | Week 7 |
| 24 | PPC control desk | Kaan, PPC Lead | Dispatching 510 MW for the first time (simulation) | Week 8 |
| 25 | Control room, frequency event | Kaan, Grid Operator | Real frequency deviation — synthetic inertia activates | Week 8 |
...
- `[ ]` Ch 20: The Ferranti Effect and the STATCOM Decision
- `[ ]` Ch 21: Harmonics, Flicker, and Power Quality

### Part VI: Talking to the Grid (~85 pages)
- `[ ]` Ch 22: Grid Codes
- `[ ]` Ch 23: Fault Ride-Through
- `[ ]` Ch 24: The Power Plant Controller
- `[ ]` Ch 25: Frequency Response and Synthetic Inertia
