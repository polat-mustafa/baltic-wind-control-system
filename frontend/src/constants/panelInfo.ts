...
export const windRoseInfo: InfoContent = {
  title: "Wind Rose — Directional Frequency Distribution",
  description:
    "Shows the frequency of wind directions and speeds at hub height (150 m). " +
    "Each petal represents a 30-degree directional sector. Longer petals indicate " +
    "more frequent wind from that direction. Color bands show speed ranges.",
  standard: "IEC 61400-1 Annex B — Wind conditions for design",
  parameters: [
    { name: "Hub height", description: "150 m (V236-15.0 MW)" },
    { name: "Sectors", description: "12 × 30° bins" },
    { name: "Data source", description: "ERA5 reanalysis at 100 m, extrapolated via power law" },
  ],
  interpretation:
    "Dominant wind direction indicates optimal turbine yaw orientation. " +
    "A narrow rose means consistent wind; a broad rose means variable conditions.",
};

export const farmLayoutInfo: InfoContent = {
  title: "Farm Layout — Turbine Positioning Map",
  description:
    "Shows the physical positions of all 34 V236-15.0 MW turbines arranged in 6 strings. " +
    "Layout optimized for prevailing SW winds with minimum 7D spacing to reduce wake losses.",
  standard: "IEC 61400-1 — Wind farm layout guidelines",
  parameters: [
    { name: "Spacing", description: "7D crosswind × 10D downwind (D = 236 m)" },
    { name: "Strings", description: "6 parallel strings, 5–6 turbines each" },
    { name: "Cable route", description: "66 kV array cables to central OSS" },
  ],
  interpretation:
    "Colors indicate relative energy production per turbine. Edge turbines " +
    "typically produce more due to less wake interference.",
};

export const weibullInfo: InfoContent = {
  title: "Weibull Distribution — Wind Speed Probability",
  description:
    "Statistical fit of the wind speed frequency distribution using the Weibull function. " +
    "Shape (k) and scale (A) parameters define the curve. " +
    "Higher k = more consistent wind; higher A = higher average speed.",
  standard: "IEC 61400-12-1 — Power performance testing",
  parameters: [
    { name: "k (shape)", description: "Typically 2.0–2.5 for offshore Baltic" },
    { name: "A (scale)", description: "Related to mean wind speed (m/s)" },
    { name: "AEP basis", description: "Integrated with power curve for energy yield" },
  ],
  interpretation:
    "The curve shows how often each wind speed occurs. " +
    "The peak indicates the most frequent speed. Area under curve = 100%.",
};

export const wakeLossInfo: InfoContent = {
  title: "Wake Loss Analysis — Turbine Interaction Effects",
  description:
    "Quantifies energy lost due to upstream turbines reducing wind speed for downstream units. " +
    "Uses Jensen/Bastankhah wake models to simulate velocity deficit.",
  standard: "IEC 61400-12-4 — Numerical site calibration",
  parameters: [
    { name: "Wake model", description: "PyWake (Jensen/Bastankhah)" },
    { name: "TI ambient", description: "Turbulence intensity at freestream" },
    { name: "Loss range", description: "Typically 5–15% for offshore farms" },
  ],
  interpretation:
    "Higher losses for closely-spaced or aligned turbines. " +
    "Inner-row turbines experience more wake than edge turbines.",
};

export const aepCascadeInfo: InfoContent = {
  title: "AEP Cascade — Energy Yield Waterfall",
  description:
    "Step-by-step breakdown from gross energy to net P50/P75/P90 AEP estimates. " +
    "Each bar shows a loss factor: wake, availability, electrical, curtailment.",
  standard: "IEC 61400-12-1 + DNV GL Energy Yield Assessment",
  parameters: [
    { name: "Gross AEP", description: "Theoretical maximum (no losses)" },
    { name: "P50 Net", description: "50% exceedance probability (median)" },
    { name: "P90 Net", description: "90% exceedance — used for bankability" },
    { name: "LCOE", description: "Levelized Cost of Energy (EUR/MWh)" },
  ],
  interpretation:
    "Read left to right: each deduction reduces energy. " +
    "P90 AEP is what banks use for financing. LCOE determines economic viability.",
};

export const layoutComparisonInfo: InfoContent = {
  title: "Layout Comparison — Optimization Analysis",
  description:
    "Side-by-side comparison of different turbine layout configurations. " +
    "Shows how spacing and arrangement affect total farm AEP and wake losses.",
  standard: "DNV-RP-J103 — Layout Assessment of Offshore Wind Farms",
  interpretation:
    "Wider spacing reduces wake losses but requires more cable. " +
    "The optimal layout balances energy yield against infrastructure cost.",
};
