 ...
 *
 * Loads turbine config + Cp surface on mount. Shows parameter controls
 * sidebar (wind scenario, simulation settings) and "Run Simulation" button.
 * Once simulation completes, renders full TurbinePhysicsDashboard.
 *
 * Follows the ForecastPage pattern: 2/3 dashboard + 1/3 controls.
 */
              ...
              <div className="space-y-2 text-xs">
                <div>
                  ...
                  <span className="text-text-muted">
                    {" "}
                    — Power coefficient. Fraction of wind kinetic energy
                    captured by rotor
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="text-text-muted">
                    {" "}
                    — Max theoretical Cp = 16/27 ≈ 0.593. No rotor can exceed this
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span className="text-text-muted">
                    {" "}
                    — D=236m, cut-in 3 m/s, rated 12.5 m/s, cut-out 31 m/s
                  </span>
                </div>
                <div>
                  <span className="font-medium text-text-secondary">Pitch</span>
                  <span className="text-text-muted">
                    {" "}
                    — PI controller feathers blades above rated to limit power at 15 MW
                  </span>
                </div>
                <div>
                  <span className="font-medium text-text-secondary">Yaw</span>
                  <span className="text-text-muted">
                    {" "}
                    — Nacelle tracks wind direction. Deadband ±8° avoids hunting
                  </span>
                </div>
              </div>
            </CardContent>
